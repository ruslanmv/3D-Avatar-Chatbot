...
(function (global) {
    ...
    var CSS = [
        ...
        '.nexus-try-on-looks{display:grid;grid-template-columns:repeat(3,1fr);gap:.5rem;margin:.2rem 0 .7rem;text-align:left}',
        '.nexus-try-on-card{position:relative;display:flex;flex-direction:column;gap:.3rem;padding:.35rem;',
        ...
        '.nexus-try-on-thumb{width:100%;aspect-ratio:3/4;object-fit:cover;border-radius:7px;display:grid;',
        ...
        '.nexus-try-on-looks{grid-template-columns:repeat(3,1fr)}}',
