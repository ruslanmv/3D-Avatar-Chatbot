...
const CurrentMediaContext = (() => {
    ...
    function systemPromptSuffix() {
        ...
        return [
            ...
            'For social or subjective follow-ups such as “do you like this?”, “what do you think?”,',
            'or “is this good?”, answer like a conversational companion using the title, creator,',
            'description and apparent mood. Do NOT lead with a generic capability disclaimer such',
            'as “I cannot hear or enjoy music”. You may say what you like about the apparent vibe',
            'while staying honest that you cannot directly hear or see the media itself.',
            'Only foreground that limitation when the question actually requires the sound, frames,',
            'lyrics, captions or a specific moment that is not present in the metadata below.',
