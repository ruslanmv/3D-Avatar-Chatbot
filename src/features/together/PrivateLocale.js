...
(function (global) {
    ...
    const PACKS = {
        'en-US': {
            ...
            'preflight.place': 'Loading this place',
            'preflight.movement': 'Warming up her movements',
            'preflight.soundtrack': 'Finding a soundtrack',
            'preflight.title': 'Getting ready…',
            'preflight.allReady': 'Everything is ready',
            'ready.begin': 'Ready to begin',
            'ready.anyway': 'Start anyway',
            'ready.retry': 'Try again',
        ...
        'es-ES': {
            ...
            'preflight.place': 'Cargando este lugar',
            'preflight.movement': 'Preparando sus gestos',
            'preflight.soundtrack': 'Buscando música',
            'preflight.title': 'Preparando…',
            'preflight.allReady': 'Todo está listo',
            'ready.begin': 'Listo para empezar',
            'ready.anyway': 'Empezar igualmente',
            'ready.retry': 'Reintentar',
        ...
        'it-IT': {
            ...
            'preflight.place': 'Carico questo luogo',
            'preflight.movement': 'Preparo i suoi gesti',
            'preflight.soundtrack': 'Cerco la musica',
            'preflight.title': 'Mi preparo…',
            'preflight.allReady': 'È tutto pronto',
            'ready.begin': 'Pronti a cominciare',
            'ready.anyway': 'Comincia lo stesso',
            'ready.retry': 'Riprova',
        ...
        'fr-FR': {
            ...
            'preflight.place': 'Je charge ce lieu',
            'preflight.movement': 'Je prépare ses gestes',
            'preflight.soundtrack': 'Je cherche une musique',
            'preflight.title': 'Préparation…',
            'preflight.allReady': 'Tout est prêt',
            'ready.begin': 'Prêt à commencer',
            'ready.anyway': 'Commencer quand même',
            'ready.retry': 'Réessayer',
        ...
        'de-DE': {
            ...
            'preflight.place': 'Dieser Ort wird geladen',
            'preflight.movement': 'Ihre Bewegungen werden vorbereitet',
            'preflight.soundtrack': 'Musik wird gesucht',
            'preflight.title': 'Wird vorbereitet…',
            'preflight.allReady': 'Alles ist bereit',
            'ready.begin': 'Bereit anzufangen',
            'ready.anyway': 'Trotzdem anfangen',
            'ready.retry': 'Erneut versuchen',
        ...
        'pt-BR': {
            ...
            'preflight.place': 'Carregando este lugar',
            'preflight.movement': 'Preparando os gestos dela',
            'preflight.soundtrack': 'Procurando uma trilha',
            'preflight.title': 'Preparando…',
            'preflight.allReady': 'Está tudo pronto',
            'ready.begin': 'Pronto para começar',
            'ready.anyway': 'Começar mesmo assim',
            'ready.retry': 'Tentar de novo',
        ...
        'ja-JP': {
            ...
            'preflight.place': 'この場所を読み込んでいます',
            'preflight.movement': '彼女の動きを準備しています',
            'preflight.soundtrack': '音楽を探しています',
            'preflight.title': '準備しています…',
            'preflight.allReady': 'すべて準備できました',
            'ready.begin': 'はじめる準備ができました',
            'ready.anyway': 'このまま始める',
            'ready.retry': 'もう一度試す',
        ...
        'ko-KR': {
            ...
            'preflight.place': '이 장소를 불러오는 중',
            'preflight.movement': '그녀의 움직임을 준비하는 중',
            'preflight.soundtrack': '음악을 찾는 중',
            'preflight.title': '준비 중…',
            'preflight.allReady': '모두 준비됐어요',
            'ready.begin': '시작할 준비가 됐어요',
            'ready.anyway': '그래도 시작하기',
            'ready.retry': '다시 시도',
        ...
        'zh-CN': {
            ...
            'preflight.place': '正在加载这个场景',
            'preflight.movement': '正在准备她的动作',
            'preflight.soundtrack': '正在寻找音乐',
            'preflight.title': '正在准备…',
            'preflight.allReady': '一切就绪',
            'ready.begin': '可以开始了',
            'ready.anyway': '仍然开始',
            'ready.retry': '重试',
