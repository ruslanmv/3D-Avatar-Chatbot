...
The 3D Avatar Chatbot now includes enhanced speech-to-text (STT) capabilities
for both **desktop** and **VR** platforms. This implementation uses the **Web
Speech API** with advanced features like interim results, microphone permission
handling, and VR controller push-to-talk.
...
The implementation uses the browser's built-in **Web Speech API** for speech
recognition:
...
**Last Updated:** 2026-01-04 **Version:** 0.5.0
